...
export const frequencies: PricingTierFrequency[] = [
  { id: "1", value: "1", label: "Hour", priceSuffix: "/hour" },
];
...
export const tiers: PricingTier[] = [
  {
    ...
    price: { "1": "$30" },
    discountPrice: { "1": "" },
    description: `We allow credit card and cash money`,
    features: [``],
    featured: false,
    highlighted: false,
    soldOut: false,
...
export default function PricingPage() {
  ...
  const tier = tiers[0];
  const bannerText = "Save 25% on first rent of field";
        ...
        <div className="mx-auto max-w-7xl px-6 xl:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="text-black dark:text-white mt-6 md:text-xl max-w-prose">
              We rent a soccer fields that can you use by $30 USD per hour, are
              the best fields in the city.
            </p>
          </div>
